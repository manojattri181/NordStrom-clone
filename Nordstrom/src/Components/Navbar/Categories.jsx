...
const [show,setShow] = useState(false);
 ...
 function Toggle(){
    return (
        <Flex w="100%"  m="auto" top="25px"  p="40px 0px 40px 180px"  justifyContent="space-around" shadow="md" >
            ...
            <Flex direction="column" gap="10px" w="400px">
           <Button w="40px" bg="white" ml="200px" mb="10px" fontSize="20px"  onClick={()=>setShow(!show)} ><Icon as={GrClose} /></Button>
                    <Box boxSize='sm'>
 ...
 return (
        <>
    <Flex  w='80%'  m="auto" pt="10px"  position="relative" justifyContent="space-between">
        <UnorderedList  listStyleType="none" display="flex" w="100%" justifyContent="space-between">
             <ListItem><Button onClick={navi} bg="white"  fontWeight="400" _hover={theme} onMouseEnter={handleshow}>Anniversary Sale</Button></ListItem>
             <ListItem><Button onClick={navi} onMouseEnter={handleshow2}  bg="white" fontWeight="400"   _hover={theme}>Women</Button></ListItem>
             <ListItem><Button onClick={navi} bg="white" fontWeight="400"  _hover={theme}  onMouseEnter={handleshow3} >Men</Button></ListItem>
             <ListItem><Button onClick={navi} bg="white" fontWeight="400"  _hover={theme}  onMouseEnter={handleshow2} >Kids</Button></ListItem>
             <ListItem><Button onClick={navi} bg="white" fontWeight="400"  _hover={theme} onMouseEnter={handleshow}>Young Adult</Button></ListItem>
             <ListItem><Button onClick={navi} bg="white" fontWeight="400"  _hover={theme} onMouseEnter={handleshow}>Activewear</Button></ListItem>
             <ListItem><Button onClick={navi} bg="white" fontWeight="400"  _hover={theme}  onMouseEnter={handleshow3}>Home</Button></ListItem>
             <ListItem><Button onClick={navi} bg="white" fontWeight="400"  _hover={theme}  onMouseEnter={handleshow2}>Beauty</Button></ListItem>
             <ListItem><Button onClick={navi} bg="white" fontWeight="400"  _hover={theme}  onMouseEnter={handleshow3}>Designer</Button></ListItem>
             <ListItem><Button onClick={navi} bg="white" fontWeight="400"  _hover={theme} onMouseEnter={handleshow}>Gifts</Button></ListItem>
             <ListItem><Button onClick={navi} bg="white" fontWeight="400"  _hover={theme}  onMouseEnter={handleshow3}>Sale</Button></ListItem>
        </UnorderedList>
        </Flex>
        {show && <Toggle/> }
        {show2 && <Toggle2/> }

...
export default function Footer() {
  return (
    ...
    <Flex w="100%" h="auto" m="auto"  bg="#f9f9f9" p="40px 200px 40px 180px " mb="30px" justifyContent="space-around" >
    <Flex direction="column" gap="13px" maxW="150px" overflow="wrap" >
        <Link ><Text as="b">Customer Services</Text></Link>
         {
             row1.map((i,a)=>(
                <Link key={a}><Text as="p" >{i}</Text></Link>
            ))
         }
         <Flex pr="150px">
        <Image
    ...
    <Flex direction="column" gap="10px" maxW="150px" overflow="wrap" >
    ...
    <Flex direction="column" gap="10px" maxW="120px" overflow="wrap" >
        <Link><Text as="b" >Nordstrom, Inc.</Text></Link>
        {
             row5.map((i,a)=>(
                <Link key={a} ><Text as="p" >{i}</Text></Link>
            ))
    ...
    <Flex w="50%" ml="160px" mt="-50px"  justifyContent="space-evenly" bg="#f9f9f9" >
    {
             last.map((i,a)=>(
                <Link key={a}><Text as="p" fontSize="14px" >{i}</Text></Link>
                ))
            }
